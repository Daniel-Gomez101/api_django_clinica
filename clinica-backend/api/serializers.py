...
# ==========================================================
# 12. SERIALIZADORES ANIDADOS (AGREGA ESTOS 3 AQUÍ ABAJO)
# ==========================================================

class CitaDetalleSerializer(serializers.ModelSerializer):
    """Muestra la Cita con los datos completos del Médico y Paciente"""
...
class TratamientoMedicamentoDetalleSerializer(serializers.ModelSerializer):
    """Muestra la relación con el objeto completo del Medicamento"""
    medicamento = MedicamentoSerializer(read_only=True)
    tratamiento = TratamientoSerializer(read_only=True)
...
class DetalleFacturaDetalleSerializer(serializers.ModelSerializer):
    """Muestra el detalle de facturación con los datos de la Factura y Cita completos"""
